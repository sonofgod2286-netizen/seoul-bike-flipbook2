...
FLIPBOOK.Main = class {
    static defaultOptions = {
        ...
        assets: {
            ...
            backgroundMp3: 'src/assets/mp3/background.mp3',
        },
        pdfUrl: null,
        ...
        strings: {
            print: '프린트',
            printLeftPage: '왼쪽페이지 프린트',
            printRightPage: '오른쪽페이지 프린트',
            printCurrentPage: '현재페이지 프린트',
            printAllPages: '전체페이지 프린트',
            download: '다운로드',
            downloadLeftPage: '왼쪽페이지 다운로드',
            downloadRightPage: '오른쪽페이지 다운로드',
            downloadCurrentPage: '현재페이지 다운로드',
            downloadAllPages: '-',
            bookmarks: '북마크',
            bookmarkLeftPage: '왼쪽페이지 북마크하기',
            bookmarkRightPage: '오른쪽페이지 북마크하기',
            bookmarkCurrentPage: '현재페이지 북마크하기',
            search: '검색',
            findInDocument: '검색',
